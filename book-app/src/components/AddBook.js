...
function AddBook() {
  ...
  return (
    <div>
      ...
      <div class="block p-18 rounded-lg shadow-lg bg-white max-w-2xl justify-items-center m-10 ml-96">
  <form onSubmit={handleSubmit}>
    ...
    <button type="submit" class="
      ...
      transition
      duration-150
      ease-in-out">Add Book</button>




</form>
{/*  hover:bg-blue-700 text-white hover:shadow-lg */}
